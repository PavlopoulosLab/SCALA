...
def main(argv):
    ...
    if args.genomeBuild == "hg19":
        ...
        if not os.path.exists(feather1):
            print ("hg19-500bp-upstream-10species.mc9nr.feather is not in %s!" % args.annFolder)
            sys.exit(1)
        if not os.path.exists(feather2):
            print ("hg19-tss-centered-10kb-10species.mc9nr.feather is not in %s!" % args.annFolder)
            sys.exit(1)
        if not os.path.exists(tbl):
    ...
    if args.genomeBuild == "hg38":
        feather1 = args.annFolder+"/hg38__refseq-r80__500bp_up_and_100bp_down_tss.mc9nr.feather"
        feather2 = args.annFolder+"/hg38__refseq-r80__10kb_up_and_down_tss.mc9nr.feather"
        tbl = args.annFolder+"/motifs-v9-nr.hgnc-m0.001-o0.0.tbl"
        TFs = args.annFolder+"/hs_hgnc_curated_tfs.txt"
