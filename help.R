...
doublets_tab_rna <- HTML('<p> 
                            ...
                            the analysis to visualize doublets and optionally remove them from the dataset that is being processed.
                          </p>
                          <img src = "images/help_page/Doublets_RNA_Intro.png" width = 900 height =200
                          style="border: 1px solid #222d32; border-radius: 15px;">
                          <figcaption style = "font-size:14px" class="figure-caption text-left"><b>Figure:</b> 
                            Overview of DoubletFinder summarizing the basic steps of analysis (obtained from tool\'s github page)
                            For more information please visit this <a href="https://github.com/chris-mcginnis-ucsf/DoubletFinder"> page </a>.
                          </figcaption>
                          <br>
                          <p>
                            <ul><h3>Main steps of DoubletFinder</h3><ul>
                              <li> Generation of artificial doublets </li>
                              <li> Preprocessing of the mergred real & artificial data </li>
                              <li> Calculation of each cell\'s proportion of artificial k-nearest neighbors (pANN) </li>
                              <li> Ranking, ordering and thresholding of pANN parameter based on the number of expected doublets </li>
                            </ul>
                          <p/>
                          <p>
                            In the following panels the main parameters of the the analysis are shown. Please make sure not to run DoubletFinder
                            in aggregated data originated from multiple samples run on different lanes (e.g. wt and diseased). 
                          </p>
                          <img src = "images/help_page/Doublets_RNA_Input1.png" style="border: 1px solid #222d32; border-radius: 15px;">
                          <p>
                            In the next section the user can view the output of the analysis. In the left there is a umap showing the singlets
                            and the predicted total doublets, while in the right the two columns from doublet analysis have been added in the metadata table.
                            The columns related to the classification of cells in singlets or doublets have the following names\' structure 
                            [DF.classifications]_[artificial doublet rate]_[pK]_[number_of_total_doublets] or
                            [DF.classifications]_[artificial doublet rate]_[pK]_[number_of_only_heterotypic_doublets]
                          </p>
                          <img src = "images/help_page/Doublets_RNA_Output1.png" style="border: 1px solid #222d32; border-radius: 15px;">
                          <img src = "images/help_page/Doublets_RNA_Output2.png" style="border: 1px solid #222d32; border-radius: 15px;">
                          <p>
                            For the deletion of the doublet predicted cells, the user can select between the two aforementioned columns
                            "all doublets" or "only heterotypic doublets" and then all cells predicted as doublets (containing a True value in the
                            table column) will be removed.
                          </p>
                          <img src = "images/help_page/Doublets_RNA_Input2.png" style="border: 1px solid #222d32; border-radius: 15px;">
                        ')

doublets_tab_atac <- HTML('
                            <p> 
                              For doublet calculation in scATAC-seq datasets SCALA utilizes the doublet identification procedure implemented in 
                              ArchR.
                            </p>
                              <img src = "images/help_page/Doublets_ATAC_Intro.png" width=500 height=300
                              style="border: 1px solid #222d32; border-radius: 15px;">
                            <figcaption style = "font-size:14px" class="figure-caption text-left"><b>Figure:</b> 
                              Overview of doublet detection procedure in scATAC data, summarizing the basic steps of 
                              analysis (obtained from tool\'s manual)
                              For more information please press this 
                              <a href="https://www.archrproject.com/bookdown/how-does-doublet-identification-work-in-archr.html"> link </a>.
                            </figcaption>
                            <br>
                            <p>
                              <ul><h3>Main steps of doublet detection in ArchR</h3><ul>
                                <li> Generation of in silico doublets from the data </li>
                                <li> Projection of artificial cells in UMAP space and identification of their k-nearest neighbors </li>
                                <li> Iterative execution of the previous step to identify cells with signal similar to synthetic doublets </li>
                              </ul>
                            <p/>
                            <p>
                              In the following panels the main parameters of the the analysis are shown. More specifically the user can select the number of cells,
                              which are neighbors to a synthetic doublet, to be considered as potential doublets. Additionally the user can also decide on the order
                              of operations executed in the TF-IDF normalization process. Finally, the dimesnsionality reduction method used for the calculation of
                              k-NNs is UMAP.
                            </p>
                            <img src = "images/help_page/Doublets_ATAC_Input.png" style="border: 1px solid #222d32; border-radius: 15px;">
                            <p>
                              In the next section the user can view the output of the analysis. On the top there is a umap showing the doublet scores
                              per cell and on the bottom a second umap showing the doublet enrichment of cells. Those scores are also added as metadata
                              columns.
                            </p>
                            <img src = "images/help_page/Doublets_ATAC_Output1.png" style="border: 1px solid #222d32; border-radius: 15px;">
                            <img src = "images/help_page/Doublets_ATAC_Output2.png" style="border: 1px solid #222d32; border-radius: 15px;">
                            <p>
                              For the deletion of the doublet predicted cells, the user can filter out potential doublets utilizing
                              the parameter "filterRatio" which applies a consistent filter across multiple different samples that may 
                              have different percentages of doublets because they were run with different cell loading concentrations. 
                              The higher the filterRatio, the greater the number of cells removed as putative doublets.
                          </p>
                         ')
...
motif_tab_atac <- HTML('<div class="col-md-12 scrollable" style="background-color: #ffffff; border: 1px solid #222d32; border-radius: 15px; font-size:16px;">
                               ...
                               <h3><u> Motif enrichment analysis</u><h3>
                                ...
                                to the most significant results. Using more relaxed thresholds or a different database is suggested if the operation is not successful.
                                </p>
                                <p>
                                  Additionally, <b>ONLY WHEN</b> integration has been performed successfully from the tab "CLUSTERS\' ANNOTATION", the user can select "Integration predicted clusters" to utilize
                                  the transferred cluster labels (instead of the original clusters).
...
annot_tab_intro <- HTML('<h4 style = "line-height: 1.5; text-align:center; background-color: #ffffff; border: 1px solid #222d32; border-radius: 5px;">
                            The <b>CLUSTERS\' ANNOTATION</b> tab enables the user to perform scRNA-seq or scATAC-seq cell-cluster annotation and to assign known cell-type identity to 
                            the currently analyzed dataset.    
                         </h4>
                      ')
...
annot_atac <- HTML('
                          <div class="col-md-12 scrollable" style="background-color: #ffffff; border: 1px solid #222d32; border-radius: 15px; font-size:16px;">
                               ...
                               <h3><u> Integration analysis with scRNA-seq dataset</u><h3>
                                <p>
                                In this mode of analysis the user can upload an *.RDS file of an already analysed scRNA-seq dataset. This dataset should include cells, whch are similar to their
                                counterparts from the currently loaded scATAC dataset. Moreover, cluster labels in the scRNA dataset should be stored in the "seurat_clusters" column. After integration
                                is completed, a UMAP depicting cells colored by transferred labels is printed. The predicted cluster labels are stored in metadata table and can be selected in downstream
                                operations such as marker genes/peaks identification, motif enrichment analysis, etc.
                                </p>
                               </div>
                       ')
                          ...
                          <div class="col-md-12 scrollable" style="background-color: #ffffff; border: 1px solid #222d32; border-radius: 15px; font-size:16px;">
                               ...
                               <h3><u> Trajectory analysis (with Slingshot)</u><h3>
                                ...
                                <ul>
                                  ...
                                  <li> Cluster labels to be used (Clusters OR Integration predicted clusters)
                                  The second option should be selected, <b>ONLY WHEN</b> integration has been performed successfully from the tab "CLUSTERS\' ANNOTATION".
                                  <li> Initial and final state selection. The user should set the root and the terminal cell-cluster of the underlying differentiation process.
                                </ul>
                                </p>
                               </div>
...
grn_tab_rna <- HTML('
                    <div class="col-md-12 scrollable" style="background-color: #ffffff; border: 1px solid #222d32; border-radius: 15px; font-size:16px;">
                      ...
                      <p>
                        ...
                        After SCALA prepares the respective RDS and loom files, the user is able to download them in order to perform a local run of pyscenic pipeline by using the provided pyscenic_local.py python 
...
grn_tab_atac <- HTML('<h3><u> Gene Regulatory Network analysis</u><h3>
                      ...
                      <p>
                      Additionally, <b>ONLY WHEN</b> integration has been performed successfully from the tab "CLUSTERS\' ANNOTATION", the user can select "Integration predicted clusters" to utilize
                                  the transferred cluster labels (instead of the original clusters), as well as "Gene Integration matrix" instead of the default "Gene activity score matrix". 
                      </p>
                      <br>
                      <br>
...
tracks_tab_atac <- HTML('
                        ...
                        <p>
                        Regarding cell grouping, "Clusters" is selected by default, however <b>IF</b> integration was performed successfully "Integration predicted clusters" can be utilized.
                        </p>
                        <br>
...
##############################Utilities#########################################
utility_tab_intro <- HTML('<h4 style = "line-height: 1.5; text-align:center; background-color: #ffffff; border: 1px solid #222d32; border-radius: 5px;">
                        The <b>UTILITY OPTIONS</b> tab enables the user to perform utility tasks such as cluster mergining, deletion or renaming.      
                       </h4>
                      ')

utility_tab_rna <- HTML('
                        <h3><u> scRNA-seq utility operations</u><h3>
                        <p>
                          <ul>
                            <li><b> Set active clustering column:</b> the user can select between different metadata columns (factor), in order to set one as the active clustering column.
                            This values of the selected column are stored also in "seurat_clusters" column. The active clustering column is used in downstream steps such as DEA, functional
                            enrichment analysis, trajectory analysis, L-R analysis and GRN inference.
                            <li><b> Rename clusters:</b> in this section the user can rename the clusters of the active clustering column. This can be useful not only for annotating clusters e.g. rename of 
                            cluster "0" as "B_cells", but also for merging clusters with similar expression profiles and enriched functions e.g. renaming cluster "1", "2" as "T_cells" merges these
                            clusters together.
                            <li><b> Delete clusters:</b> this operation permits user to remove cells from downstream analysis e.g. a population of cells captured and should not be present according to 
                            the sorting strategy. Please note that after deletion of clusters the steps of the analysis following normalization have to be repeated.
                         </ul>
                        </p>
                        ')
...
ih_inputCountMatrix_rna <- HTML('
                                <img src = "images/help_page/IH_UploadCountMatrix.png">
                                <hr>
                                <img src = "images/help_page/IH_UploadCountMatrix2.png">
                        ')

ih_input10x_rna <- HTML('
                                <img src = "images/help_page/IH_Upload10x.png">
                                <hr>
                                <img src = "images/help_page/IH_UploadCountMatrix2.png">
                        ')

ih_inputRDS_rna <- HTML('
                                <img src = "images/help_page/IH_UploadRDS.png">
                                <hr>
                                <img src = "images/help_page/IH_UploadCountMatrix2.png">
                        ')

ih_inputArrow_atac <- HTML('
                                <img src = "images/help_page/IH_UploadArrow.png">
                                <hr>
                                <img src = "images/help_page/IH_UploadArrow2.png">
                        ')

ih_qc_rna <- HTML('
                                <img src = "images/help_page/IH_QC.png">
                                <hr>
                                <img src = "images/help_page/IH_QC2.png">
                  ')

ih_scaling_rna <- HTML('
                                <img src = "images/help_page/IH_Scaling.png">
                  ')

ih_flame_rna <- HTML('
                                <img src = "images/help_page/IH_Flame.png">
                  ')

ih_scenic_rna <- HTML('
                                <img src = "images/help_page/IH_scenic.png">
                                <hr>
                                <img src = "images/help_page/IH_scenic2.png">
                        ')

ih_signatureFP_rna <- HTML('
                                <img src = "images/help_page/IH_Signatures.png">
                                <hr>
                                <img src = "images/help_page/IH_Signatures2.png">
                        ')

#Estimated times of execution RNA server
# Data normalization and scaling --> 6000 cells with regress.out of one variable = 50 sec
# PCA for ---> 6000 cells = 8 sec
# clustering = 8 sec
# UMAP = 23 sec, tSNE = 24 sec
# Markers = 1m36 sec
# Signature of 5 genes = 33 sec
# gProfiler 1 cluster = 3sec
# Annotation = 22 sec
# Trajectory = 14 sec
# L-R = 15 sec
# Doublets = 2m16sec
# Cell cycle = 4sec
# GRN decoupleR = 4m05sec

#Estimated times of execution ATAC server
# LSI for 6000 cells 1m 45sec
# clustering 38 sec
# umap tsne 1m 20sec
# marker genes 3m 15sec
# marker peaks 8m 30sec
# doublets 7m 50sec
# motif 7m 05sec
# integration 11m 12 sec
# trajectory 1m 09 sec
# GRNs 36m 50 sec